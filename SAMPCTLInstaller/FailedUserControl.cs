...
namespace SAMPCTLInstaller
{
    ...
    /// </summary>
    public partial class FailedUserControl : UserControl, IInstallationDialogState
    {
        /// <summary>
        /// Can go back
        /// </summary>
        ...
        public void Awake()
        {
            errorLabel.Text = ((Installer.InstallationErrorMessage == null) ? "Unknown error" : Installer.InstallationErrorMessage);
        }
